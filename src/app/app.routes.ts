...
export const appRoutes: Routes = [
  {
    path: '',
    redirectTo: 'visual-connector-builder',
    pathMatch: 'full'
  },
  {
    path: 'theme-picker',
  ...
  {
    path: 'visual-connector-builder',
    component: VisualConnectorBuilderComponent
  },
